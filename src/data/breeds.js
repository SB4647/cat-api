export const catAPIRequestInfo = {
  url: "https://api.thecatapi.com/images/search?breed_id=",

  extraInfo: {
    method: "GET",
    headers: {
      "x-api-key": "99031155-4c9c-455a-a20e-f643e11e28a2",
    },
  },
};

export const breedsArr = [
  {
  ...
  {
    weight: { imperial: "8 - 13", metric: "4 - 6" },
    id: "cymr",
    name: "Cymric",
  ...
  {
    weight: { imperial: "10 - 12", metric: "5 - 6" },
    id: "dons",
    name: "Donskoy",
  ...
  {
    weight: { imperial: "9 - 12", metric: "4 - 6" },
    id: "lihu",
    name: "Dragon Li",
